...
def verifica_senha():
    ...
    if nome =='user' and senha =='1234':              
        ...
        nova_janela()
         ...
         messagebox.showinfo('Login', 'Acesso Permitido ' +credenciais[0])                     
         for widget in frame_cima.winfo_children():
                widget.destroy()
    else:
        messagebox.showwarning('Erro', 'Nome ou Senha incorretos!!!')    

#função após verificação senha
def nova_janela():
...
###################Configurando o frame cima
    ...
    l_nome=Label(frame_baixo, text="Acesso permitido " +credenciais[0], anchor=NE, font=('Ivy 20'), bg=co1, fg=co4)
